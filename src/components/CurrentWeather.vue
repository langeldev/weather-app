<template>
  <div class="px-2 w-full">
    ...
    >
      ...
      <h1 class="font-arial font-black text-3xl text-sky-400 pl-8 text-ellipsis overflow-hidden break-all">
        Madrid, ES
      </h1>
      ...
      <div class="text-center my-6 flex flex-wrap">
        ...
        >
          <div>
            <svg
              ...
              height="88"
              fill="currentColor"
              class="bi bi-brightness-high text-yellow-400"
              viewBox="0 0 16 16"
            >
              <path
        ...
        <div class="text-7xl text-sky-400 mt-8 w-2/3 text-right">32&deg;</div>
        <div class="w-1/3 flex flex-col justify-end items-start pt-9">
          ...
          <div class="flex text-yellow-400">
            ...
            <span class="text-xl font-semibold">40&deg;</span>
          </div>
          <div class="flex my-2 text-sky-400">
            ...
            <span class="text-xl font-semibold">30&deg;</span>
          </div>
        </div>
      ...
      <div class="flex justify-center border-t-2 border-t-sky-200 py-4">
        <div
        ...
        <div
          class="w-full self-center bg-gray-200 rounded-full h-2.5 mb-4 dark:bg-lime-50"
        >
